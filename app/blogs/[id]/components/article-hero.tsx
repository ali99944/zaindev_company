        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 bg-amber-500/10 rounded-full mb-6">
              <span className="text-amber-500 text-sm font-medium">{article.category}</span>
            </div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="block font-medium text-gray-800">{article.author.name}</span>
                <span className="text-xs">{article.author.position}</span>
              </div>
            </div>
