...
export function AppRegisterMockup() {
  return (
    <div className="relative rounded-[32px] overflow-hidden">
      ...
      <div className="relative w-full h-full bg-white pt-6">
        ...
        {/* Content */}
        <div className="relative z-10 h-full pb-8 pt-8 px-6 overflow-y-auto">
          {/* Header */}
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-700 block">رقم الجوال</label>
              <input 
                type="tel" 
            ...
            <div className="flex items-start gap-2">
              <div className="flex items-center h-5 mt-1">
                <input
                  id="terms"
                  type="checkbox"
                  className="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-amber-500"
                />
              </div>
              <label htmlFor="terms" className="text-xs text-gray-600">
                أوافق على <a href="#" className="text-amber-600">الشروط والأحكام</a> و <a href="#" className="text-amber-600">سياسة الخصوصية</a>
              </label>
            </div>
          </div>
          
          {/* Register Button */}
          <button className="w-full bg-amber-500 text-black py-1.5 rounded font-medium mb-6">
            إنشاء حساب
          </button>
          ...
          <div className="text-center">
            <p className="text-gray-600 text-sm">
              لديك حساب بالفعل؟ <a href="#" className="text-amber-600 font-medium">تسجيل الدخول</a>
            </p>
          </div>
        </div>
      </div>
